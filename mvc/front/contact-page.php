			...
			<form action="" method="post">
				<div class="row">
					...
					<div class="row">
						...
						<input type="text" name="fullname" class="form-control" id="validationDefault01" placeholder="Enter Your full name" required>
						</div>
						<div class="col-md-12 col-sm-12 col-12">
						...
						<?php
							...
							if(isset($_SESSION['Email'])){
								...
								echo "<input type='email' name='emailaddress' class='form-control' id='exampleInputEmail1' aria-describedby='emailHelp' value='$email' required>	";
							} else {
