...
if(isset($_POST['pageno'])){
				...
				$query = "SELECT sellernotes.ID AS ID,sellernotes.Status,sellernotes.Title,sellernotes.Category,sellernotes.NoteType,sellernotes.UniversityName,sellernotes.Course,sellernotes.Country,sellernotes.ID,sellernotes.NumberofPages,sellernotes.DisplayPicture,sellernotes.PublishedDate,sellernotes.SellerID,sellernotes.IsActive
				...
				$query .= "AND sellernotes.IsActive = 1 ";	
