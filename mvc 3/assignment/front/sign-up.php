						...
						<div id="sign-up-white-box">
							...
							<div class="row">
								...
								<div class="col-md-12 col-sm-12 col-12">
									...
									<input type="text" value="<?php echo $firstname; ?>" name="firstname" pattern=".*[^0-9].*.{1,}" title="Must contain 2 or more characters  and not only number" class="form-control"  placeholder="Enter your first name"  required>
								</div>
								
								
								<div class="col-md-12 col-sm-12 col-12">
									<label id="last-name">Last name</label>
									<input type="text" value="<?php echo $lastname; ?>" name="lastname" pattern=".*[^0-9].*.{1,}" title="Must contain 2 or more characters and not only number" class="form-control  validate"  placeholder="Enter your last name"  required>
								</div>

								<div class="col-md-12 col-sm-12 col-12">
								<label id="email">Email</label>
									<input type="email" value="<?php echo $email; ?>" name="email" class="form-control"  aria-describedby="emailHelp"  pattern="[a-z0-9._%+-]+@[a-z]+\.[a-z]{2,}$" placeholder="Enter your email address" required>
								</div>
