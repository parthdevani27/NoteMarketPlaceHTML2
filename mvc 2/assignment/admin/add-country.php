			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-12">
						...
						<input type="text" class="form-control" id="validationDefault01" placeholder="INDIA" required>
					</div>
					
					<div class="col-md-12 col-sm-12 col-12">
						<label for="validationDefault03" >Country Code*</label>
						<input type="text" class="form-control" id="validationDefault03" placeholder="Enter Your Country Code" required>
